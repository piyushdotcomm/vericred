...
const chain = process.env.NEXT_PUBLIC_CHAIN_ID === "11155111" || process.env.NEXT_PUBLIC_RPC_URL?.includes("sepolia") ? sepolia : (process.env.NEXT_PUBLIC_CHAIN_ID === "80002" || process.env.NEXT_PUBLIC_RPC_URL?.includes("amoy") || process.env.NEXT_PUBLIC_RPC_URL?.includes("polygon") ? polygonAmoy : hardhat);
